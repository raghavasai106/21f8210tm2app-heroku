...
class Property(models.Model):
    ...
    zipcode = models.CharField(max_length=9, default='00000', verbose_name = 'Zip Code')
    age_in_years = models.CharField(max_length=2, default = '', blank=True, verbose_name = 'Age (In Years)')
...
class Apartment(models.Model):
    ...
    property_id = models.ForeignKey(Property, on_delete=models.CASCADE, verbose_name = 'Property')
    client_id = models.ForeignKey(Client, default=1, on_delete=models.SET_DEFAULT, verbose_name = 'Resident')
